...
function addRow(){
    var section_number = document.getElementById('Section Number').value;
    var item_name = document.getElementById('Item Name').value;
    var item_number = document.getElementById('Item Number').value;
    ...
    cel1.innerHTML = section_number;
    cel2.innerHTML = item_name;
    cel3.innerHTML = item_number;
